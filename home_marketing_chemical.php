		...
		<div class="wrapper">     
			...
			<aside class="main-sidebar">
				<section class="sidebar">
					<ul class="sidebar-menu">
						...
						<li>
							<a href="pages/marketing_chemical/po_chemical.php">
								<i class="fa fa-file-alt"></i> <span>Purchase Order</span> 
							</a>
						</li>
						<li>
							<a href="pages/marketing_chemical/sds_chemical.php">
								<i class="fa fa-edit"></i> <span>Supplier Delivery Schedule</span> 
							</a>
						</li>
						<li>
							<a href="pages/marketing_chemical/do_chemical.php">
								<i class="fa fa-truck"></i> <span>Delivery Order</span> 
							</a>
						</li>
						<li>
							<a href="pages/marketing_chemical/summary_chemical.php">
			...
			<section class="content">
				<div class="row">
					...
					switch ($page) 
					{
						default : include 'dashboard_marketing_chemical.php';
					}
					?>
				</div>
			</section>
