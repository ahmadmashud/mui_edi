...
<body class="skin-blue">
  ...
  <li>
  <a href="pages/supplier/transaction_history.php">
	<i class="fa fa-download"></i> <span>GTF</span> 
  </a>
  </li>
  <!--<li>
  <a href="pages/marketing_product/sds_product.php">
  ...
  <li class="treeview">
	...
	<ul class="treeview-menu">
	  <li><a href="pages/marketing_product/do_product.php"><i class="fa fa-truck"></i> Delivery Order</a></li>
	  <li><a href="pages/marketing_product/replacement_product.php"><i class="fa fa-refresh"></i> Replacement</a></li>
	</ul>
  </li>
  <li>
  <a href="pages/marketing_product/qc_product.php">
	<i class="fa fa-check-square-o"></i> <span>Quality Check</span>
   </a>
  </li>
  <li>
  <a href="pages/marketing_product/summary_product.php">
  ...
  switch ($page) {
  default : include 'dashboard_supplier.php';
  }
  ?> 
  </div>
  </section>   
