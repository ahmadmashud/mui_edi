		...
		<section class="content">
			<div class="row">	
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="info-box">
						<a href="#" class="small-box-footer"><span class="info-box-icon bg-aqua">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="info-box">
						<a href="pages/delivery_chemical/sds_chemical.php" class="small-box-footer"><span class="info-box-icon bg-purple">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="info-box">
						<a href="MUI-EDI User Guide Rev.03.pdf" class="small-box-footer"><span class="info-box-icon bg-maroon">
