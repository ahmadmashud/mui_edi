...
if($_SESSION['account_status']!="Supplier" and $_SESSION['section']!="Quality"){
...
<body class="skin-blue">
  ...
  <a href="home_quality_product.php">
  ...
  <li>
  <a href="pages/quality_product/qc_product.php">
  ...
  switch ($page) {					
  default : include 'dashboard_quality_product.php';					
  }
  ?>
  </div>
  </section>
