...
$query = "SELECT po_number FROM tb_purchase_order where edi_status='RECEIVED' and po_status = 1 and supplier_name='$_SESSION[supplier]' ORDER BY po_number";
			...
			<aside class="main-sidebar">
				<section class="sidebar">
					<ul class="sidebar-menu">
						...
						<li class="active treeview">
							<a href="../../home_warehouse_product.php">
				...
				<div class="content-wrapper">
					<section class="content-header">
						<h1>&nbsp </h1>
						<ol class="breadcrumb">
							<li><a href="../../home_warehouse_product.php"><i class="fa fa-tachometer-alt"></i> Home</a></li>
								...
								<div class='row'> 
									<div class='col-md-4'>
										...
										<table id="example1" class="table table-bordered table-striped">
											...
											<?php
											$sql = mysql_query("SELECT * FROM tb_supplier_delivery_schedule WHERE sds_date < '$tgl' and sds_status = 'OPEN' and supplier_name='$_SESSION[supplier]' order by sds_number");
											...
											?>				 					  
												<tr class="body">
													...
													<td width=3%><a href="<?php echo 'sds_det.php?sds_number='.$sdo['sds_number'];''?>#popup"><center><i class="fa fa-list"></i></center></a></td>
												</tr>
											<?php 	
											}
											?>
