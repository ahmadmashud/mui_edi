<html>
	...
	<body>
		<div class="tab-content">
			<div class="form">
				<p style ="color:white; font-size:28px;">Reset Password</p>
				<p align="left"><a href="#">Please enter your username and your email.</a><br>
				<form action="pages/login/act-resetpass.php" method="POST">
				...
				<input type="hidden" name="password_type" value="Reset Password">
				<button type="submit" name="submit" class="button button-block" onclick="window.location.href='pages/login/act-resetpass.php'">Submit</button>
