			...
			<section class="content-header">
				<h1> &nbsp </h1>
					<ol class="breadcrumb">
						...
						<li class="active">Upload Drawing</li>
					</ol>
			</section>
				...
				if(in_array($file_ext, $allowed_ext) === true)
				{
					...
					{	
							...
							else
						{
							...
							$update_status = "UPDATE tb_transaction_history SET status='READY', process_status = 'ACTIVE' WHERE reference_number = '$reference_number'";		
							...
							{	
								...
								$tampilPeg=mysql_query("SELECT supplier_email FROM tb_user WHERE supplier='$supplier' and section='Engineering'");
								while($peg=mysql_fetch_array($tampilPeg))
								{	
									$peg['supplier_email']; 
									$cc=$peg['supplier_email']; 
								}
