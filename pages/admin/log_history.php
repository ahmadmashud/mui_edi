...
<body class="skin-blue">
  ...
  <div class="box-header">
	<h3 class="box-title"><b>Log History</b></h3>
  </div><!-- /.box-header -->
  <div class="box-body">
	...
	<?php
	include "../../koneksi.php";								
	$tampilPeg=mysql_query("SELECT * FROM tb_log_history order by date_login");
	while($peg=mysql_fetch_array($tampilPeg)){								
	?>          
	<tr class="body">
	  <td><?php echo $peg['date_login'];?></td>
	  ...
	  <td><?php echo $peg['account_status'];?></td>
	  <td><?php echo $peg['section'];?></td>
	  <td><?php echo $peg['supplier'];?></td>
	  <td><?php echo $peg['date_logout'];?></td>
	  <?php } ?>
	</tr>
	</tbody>
	</table>
