...
<?php
	...
	$insert_sds = "INSERT INTO tb_activity_log (date_time, username, supplier, account_status, menu, activity_description) VALUES ('$jam', '$_SESSION[username]', '$_SESSION[supplier]', '$_SESSION[account_status]', '$menu_sds', 'Export to CSV Details, SDS Number : ".$sds_number."')";
	$query_insert_sds = mysql_query ($insert_sds);

header("Content-disposition: attachment; filename=supplierdeliveryscheduledetails.xls");
?>