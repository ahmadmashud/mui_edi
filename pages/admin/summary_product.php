...
<html>
	<head>
		...
		{
			die("<script>alert('Oops! Access Failed. You are not Administrator.')</script>
			<script> onclick=location.href='../../index.php'</script>");
		}
						...
						<div class="col-xs-12">
							<div class="box">              	
								...
								<div class="box-body">
									...
									tb_purchase_order_details.item_code, tb_purchase_order_details.quantity AS po_qty, tb_purchase_order_details.supplier,
									...
									SUM(tb_supplier_delivery_order_details.quantity) AS do_qty, tb_purchase_order_details.outstanding,
									...
									WHERE tb_supplier_delivery_order_details.do_status = 'RECEIVED'
									GROUP BY tb_purchase_order_details.po_number, tb_purchase_order_details.item_code ORDER BY tb_purchase_order_details.po_number, tb_purchase_order_details.item_description";
									...
									for($i=0;$i<$n;$i++)
									{
										...
										echo "<td>$cell[supplier]</td><td>$cell[item_description]</td><td>$cell[item_code]</td><td>$cell[po_qty]</td><td>$cell[do_qty]</td><td>$cell[outstanding]</td>";
										echo "</tr>";
									}
									echo "</table>";
									echo "</div>";
