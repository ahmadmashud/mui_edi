...
$query = "SELECT po_number FROM tb_quality_control_check_details GROUP BY po_number";
											...
											<table id="example1" class="table table-bordered table-striped">
												<tr>
													...
													{						
														...
														{
															$query=mysql_query("select part_name, part_number, material_unit, quantity_receiving, if(not_good=0,quantity_receiving,sum(good)) AS sgood, sum(not_good) AS snot_good, ((sum(not_good)/quantity_receiving)*100) AS percentage_ng from tb_quality_control_check_details where po_number = '$po_number' and do_number='$do_number' group by part_number order by part_number");
										...
										<table id="example1" class="table table-bordered table-striped">
											...
											if($cek)
											{
												...
												while($row=mysql_fetch_assoc($query))
												{
													...
													<td width=17%><?php echo $row['part_number'];?></td>
													<td width=7%><?php echo $row['material_unit'];?></td>
																...
																<table id="example1" class="table table-bordered table-striped">
																	...
																	?>	
																		<tr class="body">
																			...
																			<?php $sdo['percentage_ng'];?>
																			<?php
																			$number = $sdo['percentage_ng'];
																			$number_format = number_format($number,2,",",",");
																			?>
																			<td align="right"><?php echo $number_format; echo" %";?></td>
