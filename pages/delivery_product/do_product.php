		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				<section class="content-header">
					<h1> &nbsp; </h1>
					<ol class="breadcrumb">
						<li><a href="../../home_delivery_product.php"><i class="fa fa-tachometer-alt"></i> Home</a></li>
						...
						<div class="col-xs-12">
							<div class="box">              	
								...
								<div class="box-body">					
									...
									$select_sds_details1 = mysql_query("SELECT * FROM tb_supplier_delivery_schedule WHERE shipment_status!='COMPLETELY RECEIVED' and supplier_name='$_SESSION[supplier]' and shipment_status='ON THE WAY'");
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										?>
											...
											<tr class="body">
												...
												<input type="hidden" name="quantity_delivery[]" size="12px" value="<?php echo $peg['outstanding_sdo'];?>">
												<td width=14%><input type="text" onkeypress="return isNumberKey(event)" name="quantity[]" size="12px" value="<?php echo $peg['outstanding_sdo'];?>" required></td>	
							...
							<?php		  			  
								if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']<>"")
								{
									...
									$sql =  "SELECT * FROM tb_supplier_delivery_order WHERE do_number LIKE '%$keyword%' and supplier='$_SESSION[supplier]' ORDER BY do_date DESC";
									$result = mysql_query($sql);
								}
									else
								{
									$reload = "do_product.php?pagination=true";
									$sql =  "SELECT * FROM tb_supplier_delivery_order where supplier='$_SESSION[supplier]' ORDER BY do_date DESC";
									$result = mysql_query($sql);
								}
									...
									<div class="box-header">
										...
										if(isset($_POST['cari']))
										{
											...
											?>
												...
												<?php
												$query=mysql_query("select * from tb_supplier_delivery_order where do_date between '$tanggal_awal' and '$tanggal_akhir' and supplier='$_SESSION[supplier]' order by do_date");
											}
											?>			
										...
										<div style='height:48%;overflow:auto;'>	
											...
											?>
												<tr class="body">
													...
													<td width=3%><a href="<?php echo 'export_csv_do.php?id='.$row['do_number_id'];''?>"><center><i class="fa fa-download"></i></center></a></td>
												</tr>
											<?php
											}
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									?>
										<tr class="body">
											...
											<td>
												<?php echo $data ['do_date']; ?> 
											</td>
											<td>
												<?php echo $data ['do_time']; ?> 
											</td>
											<td>
											...
											<td>
												<?php echo $data ['received_returned_date']; ?> 
											</td>
											<td>
												<?php echo $data ['received_returned_time']; ?> 
											</td>
											<td>
												<?php echo $data ['remark']; ?> 
											</td>
											<td width=3%>
												<a href="<?php echo 'export_csv_do.php?id='.$data['do_number_id'];''?>"><center><i class="fa fa-download"></i></center></a>
											</td>
										</tr>
										<?php
										$i++; 
