              ...
              <div class="box">              	
                ...
                <div class="box-body">					
				  ...
				  ?>
				    ...
				    <form action="test1.php" method="post" name="postform">
					<table class="table table-bordered table-striped">				  
					<tr>
						<td width=11% style="font-size:16px; font-family:calibri;">DO Number</td>
						<td><input type="text" name="do_number" size=25% value="<?php if(isset($_POST['do_number'])){ echo $_POST['do_number']; }?>"/></td>
						<td width=11% style="font-size:16px; font-family:calibri;" >DO Date From</td>
						<td width="50">
						<div class="input-group">								  
							<input id="reservation1" type="text" name="tanggal_awal" size=13 value="<?php echo $min_tanggal['min_tanggal'];?>">
						</div>
						</td>
						<td width="5%" style="font-size:16px; font-family:calibri;" >Until</td>
						<td>
						<div class="input-group">
							<input id="reservation2" type="text" name="tanggal_akhir" size=13 value="<?php echo $max_tanggal['max_tanggal'];?>">
						</div><!-- /.input group -->			
						</td>
						<td align="right" width="300"><button name="cari">Search</td>
					</tr>
					</table>
					</form>
				...
				if(empty($do_number) and empty($tanggal_awal) and empty($tanggal_akhir)){
				echo"<script>alert('Please choose po date from until first.')</script>";
				
				}else{
				
				?><i><b>Information : </b> Search result DO Number <b><?php echo ucwords($_POST['do_number']);?></b> from <b><?php echo $_POST['tanggal_awal']?></b> until <b><?php echo $_POST['tanggal_akhir']?></b></i><?php
				$query=mysql_query("select * from tb_supplier_delivery_order where do_number like '%$do_number%' and do_date between '$tanggal_awal' and '$tanggal_akhir'");
				}
				?>			
