...
if(isset($_POST['submit']))
{
  ...
  //$result_seq     = mysql_query($seq_sdod);
  //$seq        	  = mysql_fetch_array($result_seq);
  //$sdod_code_seq  = $seq['sdod_code'];
  //$sdod_code_seq  = (int) substr($sdod_code, -1);

  $select_sdo = mysql_query("SELECT * FROM tb_supplier_delivery_order WHERE do_number='$_POST[do_number]' and supplier_name='$_SESSION[supplier]' and sdo_status='RECEIVED'");
  ...
  $select_sdo_ret = mysql_query("SELECT * FROM tb_supplier_delivery_order WHERE do_number='$_POST[do_number]' and supplier_name='$_SESSION[supplier]' and sdo_status='RETURNED'");
