						...
						<div class="col-xs-12">
							<div class="box">              	
								...
								<div class="box-body">									
									...
									$select_sds_details = mysqli_query($conn,$query);
								
									$sds_details_count = mysqli_num_rows($select_sds_details);
									...
									{ 
										$query = "SELECT * FROM tb_supplier_delivery_schedule WHERE sds_status='OPEN' and shipment_status = 'NOT COMPLETELY' and supplier_name='$_SESSION[supplier]' order by sds_number";
										//$select_sds_fifo = mysqli_query($conn,"SELECT * FROM tb_supplier_delivery_schedule WHERE sds_status='OPEN' and supplier_name='$_SESSION[supplier]' order by sds_number");
										$select_sds_fifo = mysqli_query($conn,$query);
										
										if(mysqli_num_rows($select_sds_fifo) == 0)
										{
											echo"<script>alert('Delivery Order List Not Found!')</script>";		
										}
											else
										{
											$sds_fifo = mysqli_fetch_assoc($select_sds_fifo);													  
										}													  
									
									$show1 = mysqli_query($conn,"SELECT * FROM tb_supplier_delivery_schedule_details where supplier_name='$_SESSION[supplier]' order by sds_number");	
							...
							<div>
								...
								<!--<div id="popup">
									...
									<div class="box-header">
										...
										<?php
										$min_tanggal=mysqli_fetch_array(mysqli_query($conn,"select min(sdo_date) as min_tanggal from tb_supplier_delivery_order where supplier_name='$_SESSION[supplier]'"));
										$max_tanggal=mysqli_fetch_array(mysqli_query($conn,"select max(sdo_date) as max_tanggal from tb_supplier_delivery_order where supplier_name='$_SESSION[supplier]'"));
										?>
										...
										if(isset($_POST['cari']))
										{
											...
											?>
												...
												<?php
												$query=mysqli_query($conn,"select * from tb_supplier_delivery_order where sdo_date between '$tanggal_awal' and '$tanggal_akhir' and supplier_name='$_SESSION[supplier]' order by sdo_date");
											}
											?>			
