...
$query = "SELECT po_number FROM tb_purchase_order where edi_status='RECEIVED' and po_status = 'ACTIVE' and supplier_name='$_SESSION[supplier]' ORDER BY po_number";
								...
								<div class='row'> 
									<div class='col-md-4'>
										...
										<table id="example1" class="table table-bordered table-striped">
											...
											<?php
											$sql = mysqli_query($conn,"SELECT * FROM tb_supplier_delivery_schedule WHERE sds_date < '$tgl' and sds_status = 'OPEN' and supplier_name='$_SESSION[supplier]' order by sds_number");
										...
										if($cek)
										{
											...
											?>
												<tr class="body">
													...
													<td width=4%><?php echo $row['quantity_sds'];?></td>
													<td width=14%><?php echo $row['outstanding_sdo'];?></td>
													<?php
