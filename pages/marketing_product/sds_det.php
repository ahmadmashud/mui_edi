			...
			<div class="window">
				...
				<div style='width:100%;height:90%;overflow:auto;'>
					<table id="example1" class="table table-bordered table-striped">
						...
						$insert_sds = "INSERT INTO tb_activity_log (date_time, username, supplier, account_status, menu, activity_description) VALUES ('$jam', '$_SESSION[username]', '$_SESSION[supplier]', '$_SESSION[account_status]', '$menu_sds', 'SDS Details, SDS Number : ".$sds_number.", Part Name : ".$sdo['item_name'].", Part Number : ".$sdo['item_code'].", Quantity : ".$sdo['quantity_sds']."')";
						$query_insert_sds = mysqli_query($conn,$insert_sds);
						}
						?>	

						<?php
						$show1 = mysqli_query($conn,"SELECT * FROM tb_supplier_delivery_schedule WHERE sds_number='$sds_number'");						
