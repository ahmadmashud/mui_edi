...
<html>
	...
	$ds=mysql_query("SELECT * FROM tb_supplier_delivery_schedule where supplier='$_SESSION[supplier]' and sds_status = 'OPEN'");
	...
	$th=mysql_query("SELECT * FROM tb_transaction_history where supplier='$_SESSION[supplier]' and status= 'READY' and process_status='ACTIVE'");
