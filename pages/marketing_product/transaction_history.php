...
if($_SESSION['account_status']!="Supplier" and $_SESSION['section']!="Marketing" and $_SESSION['section']!="Chemical")
{
    die("<script>alert('<b>Oops!</b> Access Failed.
			...
			<section class="content-header">
				<h1> &nbsp </h1>
					<ol class="breadcrumb">
						...
						<li class="active">Global Transfer File</li>
					</ol>
			</section>
					...
					<div class="col-xs-12">
						<div class="box">              	
							<div class="box-header">
								<h3 class="box-title"><b>Global Transfer File</b></h3>
							</div><!-- /.box-header -->
							<div class="box-body">
								<table id="example1" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>File Name</th>
											<th width="80">Doc. Type</th>
											<th width="80">Doc. Size</th>
											<th width="80">Status</th>
											<th width="80">Request Status</th>
											<th width="100">Download</th>
											<th width="100">Req. re-download</th>
										</tr>
									</thead>
									<tbody>
									<?php
									include('config.php');
									$sql = mysql_query("SELECT * FROM tb_transaction_history where supplier='$_SESSION[supplier]' ORDER BY document_id DESC");
									...
									?>
										...
										<?php $data['document_id']; ?>
											<td class="body" align="center"><?php echo $no; ?></td>
											<td class="body" align="center"><?php echo $data['upload_date']; ?> </td>
											<td class="body"><?php echo $data['document_name']; ?> </td>																			
											<!--<?php	echo '<td><a href="'.$data['file'].'">'.$data['document_name'].'</a></td>'; ?>-->
											<td class="body" align="center"><?php echo $data['document_type'];?></td>
											<td class="body" align="center"><?php echo formatBytes($data['document_size']); ?></td>
											<td class="body" align="center"><?php echo $data['status']; ?></td>
											<td class="body" align="center"><?php echo $data['request_status']; ?></td>
											<td class="body" width=3%><a href="<?php echo 'download_file.php?document_id='.$data['document_id'];''?>#popup"><center><i class="fa fa-download"></i></center></a></td>
											<td class="body" width=3%><a href="<?php echo 're-download_file.php?document_id='.$data['document_id'];''?>#popup"><center><i class="fa fa-redo"></i></center></a></td>
										</tr>
										<?php
										$no++;
									}			
