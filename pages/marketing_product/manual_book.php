...
<body class="skin-blue">
  ...
  <div class="box-header">
	<h3 class="box-title"><b>Manual Book</b></h3>
  </div><!-- /.box-header -->
  <div class="box-body">

<object data="MUI-EDI User Guide Rev.01.pdf" type="application/x-pdf" title="MUI-EDI User Guide" width="100%" height="1000%">
    <a href="../../document/MUI-EDI User Guide Rev.01.pdf"><center><i style="color:red" class="fa fa-file-pdf-o"></i></center></a> 
</object>
