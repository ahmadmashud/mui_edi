	...
	<body class="skin-blue">
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				$min_tanggal=mysql_fetch_array(mysql_query("select min(po_date) as min_tanggal from tb_purchase_order_details where supplier_name='$_SESSION[supplier]'"));
				$max_tanggal=mysql_fetch_array(mysql_query("select max(po_date) as max_tanggal from tb_purchase_order_details where supplier_name='$_SESSION[supplier]'"));
				?>
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="box">              	
								...
								tb_purchase_order_details.item_code, tb_purchase_order_details.quantity_order AS po_qty,
								tb_supplier_delivery_order_details.sds_number,  
								tb_supplier_delivery_order_details.sdo_date, tb_supplier_delivery_order_details.do_number, 
								...
								<div style="overflow-x:auto;">
									...
									for($i=0;$i<$n;$i++)
									{
										...
										echo "<td>$cell[item_name]</td><td>$cell[item_code]</td><td>$cell[po_qty]</td><td>$cell[do_qty]</td><td>$cell[outstanding]</td>";
										echo "</tr>";
									}
									echo "</table>";
								echo "</div>";
