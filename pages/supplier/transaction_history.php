...
<body class="skin-blue">
  ...
  <li class="header">MAIN NAVIGATION</li>
	<li class="active treeview">
		<a href="../../home_supplier.php">
	  <i class="fa fa-home"></i> <span>Home</span> 
		</a>
	</li>
	<li>
		<a href="transaction_history.php">
	  <i class="fa fa-file-text"></i> <span>GTF</span> 
		</a>
	</li>
    <!--<li>
  ...
  <li class="treeview">
	...
	<ul class="treeview-menu">
	  ...
	  <li><a href="drawing1.php"><i class="fa fa-download"></i>Download Drawing</a></li>
	</ul>
  </li>
	<li>
    <a href="transaction_history.php">
  ...
  <h1> &nbsp </h1>
  <ol class="breadcrumb">
  <li><a href="../../home_supplier.php"><i class="fa fa-dashboard"></i>Home</a></li>
				  ...
				  echo"<script>alert('No data to display.')</script>";
					...
					while($data = mysql_fetch_assoc($sql)){						
						...
						<tr bgcolor="#fff">
							...
							<td align="center"><?php echo $data['process_status']; ?></td>
							<td width=3%><a href="<?php echo 'download_file.php?document_id='.$data['document_id'];''?>#popup"><center><i class="fa fa-download"></i></center></a></td>
						</tr>
						<?php
						$no++;
					}
