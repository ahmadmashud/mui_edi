...
$row2 = mysql_fetch_array($query_email2);
	...
	This notification just to remind that there are some Drawing that are ready to be Downloaded with a title : ".$rows_th['document_name']." 
	and here are the Reference Number to download: <b>".$rows_th['reference_number']."</b>
