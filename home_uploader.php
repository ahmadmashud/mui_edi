...
if($_SESSION['account_status']!="Project Control Officer" and $_SESSION['section']!="Project Control"){
    die("<script>alert('Oops! Access Failed. You are not Project Control Officer.')</script>
        <script> onclick=location.href='index.php'</script>");
}
		    ...
		    <aside class="main-sidebar">
				<section class="sidebar">
					<ul class="sidebar-menu">
						...
						<li>
							<a href="pages/user/upload_user.php">
								<i class="fa fa-upload"></i> <span>Upload Document</span> 
							</a>
						</li>
						<li>
							<a href="pages/user/transaction_history.php">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="row">
						...
						switch ($page) 
						{
							default : include 'dashboard_uploader.php';
						}
						?> 
				    </div>
				</section>   
