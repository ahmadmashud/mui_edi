...
if($_SESSION['account_status']!="Supplier" and $_SESSION['section']!="Delivery")
{
			...
			<aside class="main-sidebar">
				<section class="sidebar">
					<ul class="sidebar-menu">
						...
						<li>
							<a href="pages/delivery_chemical/sds_chemical.php">
								<i class="fa fa-edit"></i> <span>Supplier Delivery Schedule</span> 
							</a>
						</li>
						<li>
							<a href="pages/delivery_chemical/do_chemical.php">
			...
			<div class="content-wrapper">
				...
				<section class="content">	  
					<div class="row">
						...
						switch ($page) 
						{
							default : include 'dashboard_delivery_chemical.php';
						}
						?>
					</div>
				</section>
