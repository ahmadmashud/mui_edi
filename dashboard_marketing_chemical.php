...
<html>
	...
	<section class="content">
		<div class="row">
			...
			<div class="info-box">
				<a href="pages/marketing_chemical/po_chemical.php" class="small-box-footer">
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="info-box">
					<a href="pages/marketing_chemical/sds_chemical.php" class="small-box-footer">
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="info-box">
					<a href="MUI-EDI User Guide Rev.03.pdf" class="small-box-footer">
						<span class="info-box-icon bg-maroon"><i class="fas fa-book"></i></span>
					</a>
				<div class="info-box-content">
