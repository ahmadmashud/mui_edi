		...
		<div class="wrapper">     
			...
			<aside class="main-sidebar">
				<section class="sidebar">
					<ul class="sidebar-menu">
						...
						<li>
							<a href="pages/marketing_product/po_product.php">
						...
						<li>
							<a href="pages/marketing_product/do_product.php">
						...
						<li>
							<a href="pages/marketing_product/transaction_history.php">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					switch ($page) 
					{
						default : include 'dashboard_marketing_product.php';
					}
					?>
					</div>
				</section>
