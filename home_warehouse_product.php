...
if($_SESSION['account_status']!="Supplier" and $_SESSION['section']!="Warehouse"){
...
<body class="skin-blue">
  ...
  <li>
  <a href="pages/warehouse_product/sds_product.php">
  ...
  <li>
  <a href="pages/warehouse_product/qc_product.php">
  ...
  switch ($page) {					
  default : include 'dashboard_warehouse_product.php';				
  }
  ?>
  </div>
  </section>
